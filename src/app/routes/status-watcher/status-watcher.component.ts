...
@Component({
  selector: 'app-status-watcher',
  templateUrl: './status-watcher.component.html',
  styleUrls: ['./status-watcher.component.less'],
  styles: []
})
export class StatusWatcherComponent implements OnInit, OnDestroy {
